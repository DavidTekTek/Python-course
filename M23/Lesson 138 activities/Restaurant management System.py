# Import tkinter for GUI and tik for improved widgets
import tkinter as tk
from tkinter import ttk, messagebox

# Define the Restaurant Management App class
class RestaurantOrderManagement:
    def __init__(Self, root):
        ...
        for i, (item, price) in enumerate(self.menu_items.items(), start=1):
            ...
            currency_dropdown = ttk.Combobox(frame, textvariable=self.currency_var, state="randomly", width=18, values=('USD', 'Naira'))
            ...
            def update_menu_prices(self, *arg):
